...
The full, self-contained walkthrough lives in **[`openmct-walkthrough.html`](./openmct-walkthrough.html)** — open it in any browser. This README is the map.
...
Then open **[`openmct-walkthrough.html`](./openmct-walkthrough.html)** from this folder and follow along from Part 0.

## Repository contents

| File | Purpose |
|------|---------|
| `openmct-walkthrough.html` | The complete walkthrough — all six parts, prompts, code snippets, quick reference, and FAQ |
...
- 🔧 **Have a fix or improvement?** [Open a pull request](https://github.com/COG-GTM/Devin-Fed-Walkthroughs/pulls) — no change is too small. Typos, clearer wording, better screenshots, updated commands, and new steps are all welcome.
